          ...
          <div className="navbar-nav ms-auto">
            {isAuthenticate ? (
              ...
              <>
                ...
                <Link to="/conocenos" className="nav-item nav-link">Conócenos</Link>
                <Link to="/cotizacion" className="nav-item nav-link">Cotización</Link>
                <Link to="/carrito" className="nav-item nav-link">Productos</Link>
                <Link to="/login" className="nav-item nav-link">Inicio Sesión</Link>
