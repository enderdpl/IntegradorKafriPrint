...
function Preguntas() {
  return (
    ...
    <div>
      ...
      <h4>Escríbenos vía WhatsApp o en la sección  `Contacto` o  `Cotización` en nuestra página.</h4>
      <div className="preg"> <i className="fas fa-question" />
        <span className="icon-label">¿Tienen opciones de envío?</span></div><br />
      <h4>¡Claro! Enviamos por empresas de transportes tales como: Starken, Correos de Chile, Chevalier y Varmontt.</h4>
      <div className="preg"> <i className="fas fa-question" />
        <span className="icon-label">¿Con qué tipo de estampado trabajan?</span></div><br />
      <h4>Trabajamos con sublimación y vinilo sobre tela algodón, poliester, mascarillas, bolsas de género, entre otras cosas.</h4>
      <div className="preg"> <i className="fas fa-question" />
        <span className="icon-label">¿Puedo ver los productos de forma presencial?</span></div><br />
      <h4>Por el momento no contamos con local físico, sin embargo, en nuestras RR.SS. avisamos cada vez que participamos<br /> en una exposición presencial o en ferias artesanales.</h4>
    </div>
  )
}
