      ...
      <div className="container px-5">
        <div className="row gx-5 align-items-center">
          ...
          <div className="col-lg-6 order-lg-1">
            <div className="p-5 section-container">
        ...
        <div className="row gx-5 align-items-center">
          ...
          <div className="col-lg-6">
            <div className="p-5 section-container">
              ...
              <p>
                En Krafri-Print, nos apasiona materializar tus proyectos de la
                manera más óptima y profesional. Envíanos tu idea, y la
                convertiremos en realidad. Solicita tu{" "}
                <a
                  href="/formulario.html#cotizacion"
                  style={{ color: "black" }}
                >
                  cotización aquí{" "}
                </a>
        ...
        <div className="row gx-5 align-items-center">
          ...
          <div className="col-lg-6 order-lg-1">
            <div className="p-5 section-container">
              ...
              <p>
              La impresión 3D es una tecnología que te ofrece grandes posibilidades para crear objetos personalizados, originales y funcionales. Yo estoy aquí para ayudarte a obtener una buena calidad de impresión 3D. Si tienes alguna duda o sugerencia, no dudes en contactarme.
              </p>
            </div>
          </div>
        </div>
